  ...
  return (
    <>
      <header className={props.className}>
        <div className="bg-white-A700 flex flex-col h-[83px] items-center justify-start mb-[94px] md:ml-[0] ml-[1297px] mr-[60px] md:mt-0 mt-[39px] p-0.5 rounded-[41px] w-[83px]">
          <Img
        ...
        <div className="sm:h-[212px] h-[216px] md:h-[770px] relative w-full">
          <div className="absolute bg-pink-900 flex flex-col h-max inset-[0] items-center justify-center m-auto p-[11px] w-full">
            <div className="flex flex-col gap-9 items-center justify-start mt-6 w-[95%] md:w-full">
              ...
              <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-[98%] md:w-full">
                <Text
                  className="md:mt-0 mt-[3px] text-3xl sm:text-[26px] md:text-[28px] text-center text-white-A700"
                ...
                <Text
                  className="md:ml-[0] ml-[68px] md:mt-0 mt-2 text-3xl sm:text-[26px] md:text-[28px] text-center text-white-A700"
                  size="txtInriaSansRegular30"
                >
                  Messages
                </Text>
                ...
                <Text
                  className="md:ml-[0] ml-[67px] md:mt-0 mt-[3px] text-3xl sm:text-[26px] md:text-[28px] text-center text-white-A700"
                  size="txtInriaSansRegular30"
                >
                  Documents
                </Text>
                ...
                <Text
                  className="md:ml-[0] ml-[50px] md:mt-0 mt-1.5 text-3xl sm:text-[26px] md:text-[28px] text-center text-white-A700"
                  size="txtInriaSansRegular30"
                >
                  Medical Records
                </Text>
          ...
          <Button
            className="absolute bottom-[0] cursor-pointer font-bold font-inriasans leading-[normal] left-[39%] min-w-[251px] rounded-tl-[20px] rounded-tr-[20px] text-3xl sm:text-[26px] md:text-[28px] text-center"
            color="white_A700"
            size="lg"
            variant="fill"
          >
